...
Three published conventional ethane-cracker studies were replayed with the integrated AramcoMech–Cantera–GP/process model. One missing reactor coordinate was inferred only when the source omitted it. All remaining process quantities were retained as tests.
...
| Chen 2024 | C2H6 dry fraction | fresh ethane, kg/kg | 1.108 | 1.262–1.285 |
| Chen 2024 | C2H6 dry fraction | high-T heat, GJ/t | 5.25 | 7.87–7.90 |
| Chen 2024 | C2H6 dry fraction | compressor, kWh/t | 370 | 303–312 |
| Shin 2025 | fresh ethane | C3+, kg/kg | 0.1376 | 0.1115–0.1252 |
| Shin 2025 | fresh ethane | combustion heat, GJ/t | 17.2 | 17.49–18.56 |
| Shin 2025 | fresh ethane | on-site GHG, kg/t | 442 | 431–509 |
| Wang 2026 | geometry; ramp domain | conversion | 0.685 | 0.390 |
| Wang 2026 | geometry; ramp domain | fresh ethane, kg/kg | 1.331 | 1.179 |
| Wang 2026 | geometry; ramp domain | OPEX, MUSD/y | 195.65 | 171.92 |
...
Shin provides the cleanest process-level check. Its published 17.2 GJ/t combustion energy lies 1.7% below the nearest model state, and the published 442 kgCO2e/t on-site GHG lies inside the 431–509 kg/t envelope. C3+ production remains 9–19% lower.

Wang gives a kinetic-model discrimination case. Published geometry fixes a residence time near 0.29 s. AramcoMech reaches 39.0% conversion at the fastest heating history in the current domain; the paper reports 68.5%. The original empirical reactor correlation gives 49.0% at the same temperature and residence time. The benchmark therefore identifies reaction kinetics and thermal history as the first quantities to reconcile before downstream TEA values are compared.
